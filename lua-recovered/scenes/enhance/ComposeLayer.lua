...
local var_0_14 = class("ComposeLayer", function()
...
function var_0_14.ctor(arg_4_0, arg_4_1)
	...
	arg_4_0.equipComposeLayer = require("scenes.enhance.EquipComposeLayer").new({
	...
	arg_4_0.equipComposeLayer:setPosition(-55, -5)
	arg_4_0.bgSprite:addChild(arg_4_0.equipComposeLayer)
...
function var_0_14.reloadData(arg_8_0)
	...
	arg_8_0.equipComposeLayer:removeAllEquips()
...
function var_0_14.showItemDetail(arg_21_0, arg_21_1)
	...
	local var_21_1 = arg_21_0.equipComposeLayer:addGridEquip(arg_21_1)
	...
	var_21_5:addObject(CCCallFunc:create(function()
		...
		arg_21_0.equipComposeLayer:showEquipNode(arg_21_1)
	end))
...
function var_0_14.autoButtonAction(arg_24_0, arg_24_1, arg_24_2)
	if arg_24_0.equipComposeLayer:isItemFull() == true then
		showFlashNotice(string.lf("上仙，合成炉已满，请立刻开始合成吧~~"))

		return
	end

	if arg_24_0.equipComposeLayer:canRefineNow() == false then
		print("当前不能合成")
	...
	if arg_24_0.equipComposeLayer:isItemFull() == false then
...
function var_0_14.requestEquipData(arg_31_0)
	local function var_31_0(arg_32_0)
		...
		for iter_32_0, iter_32_1 in ipairs(arg_32_0) do
			if iter_32_1.isInTeam == 0 and arg_31_0:isInRefineList(iter_32_1.equipUserId, ItemType.eEquip) == false and getItemQuality(ItemType.eEquip, iter_32_1.equipId) == QualityType.eOrange then
				local var_32_0 = {
...
function var_0_14.createHeader(arg_34_0, arg_34_1, arg_34_2)
	...
	if arg_34_1.Type == ItemType.eHero or arg_34_1.Type == ItemType.eEquip then
		...
		var_34_0.equipPinJie = arg_34_1.detail ~= nil and arg_34_1.detail.pinJie or nil
